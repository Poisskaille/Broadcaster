...
<p align="center">
    <big><big><b>/!\ THIS IS NOT EMULATION /!\</b></big></big>
</p>

Captured with "1080P HDMI USB Adapter Capture Card"

## Shortcuts to know

- **Escape** : Open Settings
- **R** : Fast reload application *(under a seconds)*
Useful if sounds does not match the video.
